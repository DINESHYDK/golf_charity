// ─── ADMIN SETTINGS PAGE ─────────────────────
// Allows the admin to update their own profile (name + avatar),
// view their account email (read-only), and find account actions.
//
// Route: /admin/settings
// Layout: (admin) shell — AdminSidebar, AdminShell wrapper
// Content mirrors the subscriber settings page — same profile endpoint,
// same validation — but rendered within the admin shell context.
      ...
      <motion.div variants={cardVariants}>
        <Card>
          ...
          <p className="text-[var(--color-text-secondary)] text-sm">
            Manage users, draws, charities, and winners from the{" "}
            <a
              href="/admin"
